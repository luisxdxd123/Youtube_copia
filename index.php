...
<body class="bg-gray-100">
        ...
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex-1 max-w-md mx-4">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a href="frontend/upload.php" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">
                        <i class="fas fa-plus mr-2"></i>Subir
                    </a>
                    <a href="frontend/my-videos.php" class="text-gray-700 hover:text-gray-900">
                        <i class="fas fa-video mr-1"></i>Mis Videos
                    </a>
                    <span class="text-gray-700">Hola, <?= htmlspecialchars($_SESSION['first_name']) ?></span>
                    <a href="frontend/logout.php" class="text-red-600 hover:text-red-800">Salir</a>
                <?php else: ?>
                    <a href="frontend/login.php" class="text-red-600 hover:text-red-800">Iniciar Sesión</a>
                    <a href="frontend/register.php" class="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700">Registrarse</a>
                <?php endif; ?>
            </div>
        </div>
    </header>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center py-12">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
            <a href="frontend/upload.php" class="inline-block mt-4 bg-red-600 text-white px-6 py-3 rounded-lg hover:bg-red-700">
                Subir Video
            </a>
            <?php endif; ?>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <a href="frontend/watch.php?v=<?= $video['id'] ?>">
                    <div class="relative">
